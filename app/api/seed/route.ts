...
const SEED_SECRET = process.env.CRON_SECRET || 'test-secret-for-local-development';
...
const sampleRegulations = [
  {
    ...
    full_analysis: {
      ...
      action_items: [
        { department: 'Quality Assurance', action: 'Audit all existing SDS documents against new requirements', deadline: '2024-01-31', priority: 'high' },
        { department: 'Technical Documentation', action: 'Update SDS templates and reformat all product documentation', deadline: '2024-02-28', priority: 'high' },
        { department: 'IT Systems', action: 'Implement digital SDS delivery system with 24/7 availability', deadline: '2024-02-15', priority: 'high' },
        { department: 'Customer Service', action: 'Train team on new SDS format and digital delivery', deadline: '2024-03-01', priority: 'medium' }
      ],
  ...
  },
  {
    ...
    full_analysis: {
      ...
      action_items: [
        { department: 'R&D', action: 'Conduct substance review and identify affected products', deadline: '2024-02-28', priority: 'high' },
        { department: 'R&D', action: 'Develop alternative formulations for restricted substances', deadline: '2024-06-30', priority: 'high' },
        { department: 'Regulatory Affairs', action: 'Prepare and submit REACH registration dossiers for new formulations', deadline: '2024-10-31', priority: 'high' },
        { department: 'Manufacturing', action: 'Update production procedures and supplier agreements', deadline: '2024-11-30', priority: 'medium' },
        { department: 'Sales & Marketing', action: 'Prepare customer communication for product changes', deadline: '2024-12-01', priority: 'medium' }
      ],
  ...
  },
  {
    ...
    full_analysis: {
      ...
      action_items: [
        { department: 'Environmental Management', action: 'Upgrade environmental monitoring systems and implement real-time tracking', deadline: '2024-06-30', priority: 'high' },
        { department: 'Operations', action: 'Update facility procedures and train staff on new reporting requirements', deadline: '2024-07-31', priority: 'medium' },
        { department: 'Compliance', action: 'Create new reporting templates and implement quarterly submission schedule', deadline: '2024-08-15', priority: 'medium' }
      ],
  ...
  try {
    ...
    for (const reg of sampleRegulations) {
      try {
        ...
        console.error(`Error adding regulation "${reg.title}":`, err);
      }
    }
